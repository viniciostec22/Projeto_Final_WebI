            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link" title="User menu" data-toggle="dropdown" aria-expanded="false">
                        <span class="mr-2 d-sm-inline d-none"><?php echo $_SESSION['nome_usuario'];?></span>
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        -->
                        <a href="logout.php" class="dropdown-item text-danger" data-sidebar-target="#settings">Sair!</a>
                    </div>
                </li>
                <!-- end::user menu -->
