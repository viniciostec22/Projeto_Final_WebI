<p class="h1">Vincular Professores ao curso</p>
<div class="col-md-12">
    <form action="page.php?page=vincular_professor" method="POST">
...
if (!empty($_POST['cst_gti_id'])) {
    ...
    //string SQL
    $sql = "INSERT INTO cst_gti_has_professores
    (cst_gti_id, professores_id) 
    values ('".$cst_gti_id."', '".$professores_id."');";
